...
[Using the Rich Text Editor](getting-started/using-the-rich-text-editor.md) for more info.

### Images

Click on the *Insert Media* button in the Rich Text Editor toolbar.

![The insert media button](images/wysiwyg-toolbar-insert-media.png)

This will open the *Media Browser*. There are tabs for images and documents.
Make sure *Images* is active.

![The image tab](images/media-browser-image-tab.png)

#### Existing Images

To add an existing image, scroll down to the thumbnails.

![A list of image thubmbails](images/view-of-media.png)

Here, you can filter by file name and change the layour between grid and table.

![The media browser with the filter and view mode areas emphesized](images/search-media.png)

When you find the image you want, click on it and click *Insert selected*.

![The media browser with an image selected and the Insert selected button emphesized](images/selected-image.png)
...
![The Select files button](images/select-files-button.png)

Select your image (make sure it is a gif, png, jpg or jpeg).

Then, make sure to add alternative text.

![The alternative text field](images/image-alternative-text.png)
...
![The save button](images/save-new-image.png)

Now your image is added to your media library and automaically selected. Click
*Insert Selected*.

![The media library with the checked image and Insert selected button emphesized](images/media-library-selected-image.png)
...
![The image toolbar](images/image-toolbar.png)

##### Caption

Use the button labeled *Toggle caption on* to add a caption.

![The caption button](images/image-toolbar-caption.png)

Then type the caption below the image.

![Caption field](images/caption.png)

##### Link

You can link the image to a webpage with the *Link* button.

![Link button](images/image-toolbar-link.png)

Enter the url (it should start with "https://") and click on the green
checkmark.

![The green check icon](images/link-check-icon.png)
...
![The override alternative text button](images/image-toolbar-override-alt-text.png)

Then enter the text and make sure you click on the green checkmark.

![Green check icon](images/alt-text-check.png)
...
![The view mode select field with thumbnail, medium and large options](images/image-view-mode-select.png)
...
![The alignment buttons](images/image-toolbar-align.png)
...
![The document tab](images/media-browser-document-tab.png)

#### Existing Documents

To add an existing document, scroll down to the thumbnails.

![A list of document thubmbails](images/view-of-documents.png)

Here, you can filter by file name and change the layour between grid and table.

![The media browser with the filter and view mode areas emphesized](images/search-documents.png)

When you find the document you want, click on it and click *Insert selected*.

![The media browser with a document selected and the Insert selected button emphesized](images/selected-document.png)
...
![The Select files button](images/select-files-button-documents.png)

Select your document (make sure it is a pdf, doc, or docx).

Then, make sure to give the document a name.

![The file name text field](images/document-name.png)
...
![The media library with the checked image and Insert selected button emphesized](images/media-library-selected-document.png)
