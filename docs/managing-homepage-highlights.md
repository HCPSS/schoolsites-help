...
![The edit button on the right side of the toolbar](../images/toolbar-edit-button.png)
...
![A screenshot of dragging a highlight](../images/drag-highlight.png)
...
![Add a highlight button](../images/add-highlight.png)

Once you click *Add* you will be presented with a page where you can find or
create news items or events.

![Tabs that read Find News, Find Event, Create News, and Create Event](../images/highlight-content-tabs.png)
...
![News search box](../images/search-for-news.png)

To select on click on the checkbox next to it and then *Select* at the bottom.

![The select button](../images/select-and-add-submit.png)

You should now see your highlight.

![The new highlight](../images/new-highlight.png)
...
![Highlight tabs](../images/create-news-highlight.png)
...
![The save button](../images/save-button.png)
