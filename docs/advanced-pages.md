...
![The list of content block types](images/content-block-types.png)

Then click *Add content block*.

![A button labeled Add content block](images/add-content-block-button.png)
...
![The Select button](images/select-athletic-team.png)

You will be presented with a page where you can find existing or create new 
items.

![tabs labeled Find Department and New Department](images/find-and-create-department-tabs.png)

#### Find an Existing Item

You can search for your item. Then select it and click *Select*.

![highlighted search bar, selected department, and select button](images/find-department-search.png)

#### Create a new Item

To create a new item, fill out the form and click *Save*.

![The new department form](images/department-webpart-form.png)
...
![An autocomplete field completing with Student Services](images/news-list-webpart.png)

You can preview what the news list will look like by clicking *Preview*.

![The preview button](images/news-list-webpart-preview.png)
...
![The person block with the Select button highlighted](images/person-select-button.png)

And after pressing it you can select an existing, or create a new *Person*.

![The create new and select existing person tabs](images/person-tabs.png)

After selecting the Person, take a look at the *Display* section at the bottom.

![The Display section at the bottom of the person block](images/person-display-details.png)
...
![The preview button](images/person-webpart-preview-button.png)

When you save the page, you will see the person block on your page.

![Redered person block](images/person-full-render.png)
...
![A block with two buttons labeled Add new resource and Add exiting resource](images/resource-content-block.png)
...
![The resource autocomplete field](images/resource-autocomplete.png)
...
![The rich text content block](images/rich-text-content-block.png)

For more information about Rich Content Editor [see the Rich Content Editor 
page](getting-started/using-the-rich-text-editor.md)
...
![Remove content block button](images/remove-content-block-button.png)
