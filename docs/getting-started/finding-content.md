...
![A screen schot of a school site with the Search link highlighted](../images/search-link.png)

## Via the Dashboard

Another way is to go to your dashboard and click *more* below the block of content you want to search.

![A screenshot of the dashboard with the more link in the News block emphasized](../images/news-more-link.png)

This will take you to a more complete view of the content, where you can search and sort.

![A screenshot of the Find News page which lists all news and has a search bar](../images/find-news-page.png)
...
![A screenshot of the content overview page with the menu item labeled content highlighted](../images/content-overview.png)
