...
![The Add button on the dashboard](images/dashboard-add-event.png)

## Create Event From the Calendar

The second is by going to your calendar. And at the top clicking Add an Event.

![The Add Event button on the calendar page](images/calendar-add-event.png)
...
![The When field with the start date and time and end time filled out](images/simple-when-field.png)
...
![The When field with the All day checkbox checked and the start and end dates filled in](images/when-field-multiday.png)
...
![The repeating field with options never, daily, weekly, monthly, and anually](images/repeating-event-frequency.png)

Then add the frequency and when the series should end (after a certain date, or
after a certain number of occurences).

![Repeating fields that show the event repeating every week and ending after 4 occurences](images/repeating-fields.png)
...
![The When field with the Add another item button emphesized](images/add-another-occurence.png)
...
!!! example
    ...
    ![The when field filled out for an event on March 3rd, 4th, and 6th at 5pm](images/multiple-unrelated-occurences.png)
...
![The calendar field](images/calendar-field.png)
...
![The existing calendar field autocompleting](images/calendar-autocomplete.png)
...
![The color field with Green selected](images/calendar-color-field.png)

Now you can see that the new item event show up with our chosen color:

![Calendar with Parent Teacher Conference in blue and Peter Pan in green](images/color-events.png)
