...
![Add newsletter button](images/add-newsletter-button.png)

### Starting from the News list

From your dashboard, scroll down to the *News* section and click *more*.

![News block more link](images/news-block-more-link.png)
...
![A screenshot emphesizing selecting news items and clicking Apply to selected items.](images/create-newsletter-from-news.png)

This will take you the the *Create Newsletter* form with the news items you
selected pre-filled.

![The newsletter form with 3 news items](images/preselected-news-items.png)
...
![Site news add content block button](images/add-news-item-content-block.png)

Then click *Select or Create News Item*.

![Select or Create News Item button](images/select-or-create-news-item-button.png)

Then, select the news item you want to insert and click *Select*. 

![The select button](images/selecting-news-item.png)

If you want to preview what the news item will look like in the newsletter, 
click *Preview*.

![Preview button](images/site-news-preview-button.png)

![Preview of the news item](images/news-item-newsletter-preview.png)

#### Site Event

Select *Site Event* and then click *Add Content Block*

![Site news add content block button](images/add-event-item-content-block.png)

Then click *Select or Create Event*.

![Select or Create News Item button](images/select-or-create-eveny-item-button.png)

Then, select the event you want to insert and click *Select*.

![The select button](images/selecting-event-item.png)

If you want to preview what the event will look like in the newsletter,
click *Preview*.

![Preview button](images/site-event-preview-button.png)

![Preview of the news item](images/event-newsletter-preview.png)

#### Event List

Select *Event List* and then click *Add Content Block*

![Add event list button](images/add-event-list-button.png)
...
![The event list form](images/event-list-form.png)

Then select the events you want to include and click *Select*.

![Event selection form](images/select-events.png)

You can draq the events to reorder them:

![Dragging an event](images/drag-event-list.png)

#### Rich Text

Select *Rich Text* and then click *Add Content Block*

![Select rich text button](images/select-rich-text-content-block.png)
...
![Add community event button](images/add-community-event-content-block.png)

Then click *Select Community Event*

![Select community event button](images/select-community-event-button.png)

Then select the news item you want to include and click *Select*.

![Select community event form](images/select-community-event.png)

If you want to preview the community event, click *preview*.

![Community event preview button](images/community-block-preview-button.png)

![Community event block preview](images/preview-community-event.png)

#### District News

Select *District News* and then click *Add Content Block*

![Add District news button](images/add-district-news-block-button.png)

Then click *Select News Item*

![Select district new button](images/select-district-news-item-button.png)

Then select an item and click *Select*

![District news select button](images/select-district-news-form.png)

If you want to preview the district news, click *preview*.

![District news preview button](images/district-news-preview-button.png)

![District news block preview](images/preview-district-news.png)

#### Other School News

Select *Other School News* and then click *Add Content Block*

![Add District news button](images/add-other-school-news-block-button.png)

Then click *select*.

![Select other school news button](images/select-other-school-news-button.png)

Then select the school.

![School select](images/school-select.png)

This will bring up a list of news items on that school website. Select one and
click *Select*.

![Other school news select](images/other-school-news-select.png)

If you want to preview the news item, click *preview*.

![District news preview button](images/other-school-news-preview-button.png)

![District news block preview](images/preview-other-school-news.png)
...
!!! question "Should Newsletters be Published?"
    ...
    ![A newsletter in the news feed](images/newsletter-in-news-feed.png)
...
![Save button](images/save-department-button.png)

## Copying Your Newsletter Into School Messenger

When viewing your newsletter click *Copy to Clipboard*

![Copy to clipboard button](images/copy-to-clipboard-button.png)

Then navigate to your draft news message in SchoolMessenger and past 
(with CTRL+v) in the body:

![School Messenger Body](images/school-messenger-body.png)

![Pasted Newsletter](images/pasted-newsletter.png)
